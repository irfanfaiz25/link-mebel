...
//whitebox admin edit data produk
function ubah($data)
{
  global $konek;
...
//whitebox admin delete data produk
function hapus($id)
{
  global $konek;
...
//whitebox admin rejecting order
...
//whitebox admin accepting order
...
//whitebox uploading foto produk
function upload()
{
...
//whitebox uploading foto bukti pembayaran
...
//whitebox updating payment proses
