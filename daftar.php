    ...
    <div class="login">
        <div class="login-dark text-center">
                    ...
                    <?php if (isset($berhasil)): ?>
                        <div class="alert alert-success" role="alert">
                            Username dan password terdaftar, silahkan <a href="login.php"
                                style="color: #e63946 !important; text-decoration: none;">login</a>
                        </div>
            ...
            <form name="formlogin" action="" method="post">
                ...
                <p style="color: antiquewhite; margin-top: 28px !important;">sudah punya akun ? <a href="login.php"
                        style="color: #e63946 !important; text-decoration: none;">login</a></p>
            </form>
        </div>
    </div>
